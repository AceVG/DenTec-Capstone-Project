                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#createwalkin" onclick="event.stopPropagation();">
                                Create Walk-in
                            </button>
                                ...
                                <div class="modal-dialog">
                                    <form class="modal-content" method="POST" action="{{ url('appointment') }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select name="time" class="form-select" required disabled></select>
                            ...
                            <div class="modal fade" id="createwalkin" tabindex="-1" aria-hidden="true" onclick="event.stopPropagation();">
                                <div class="modal-dialog">
                                    <form class="modal-content" method="POST" action="{{ url('appointment') }}">
                                        @csrf
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title">Create Walk-in</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <input type="hidden" name="status" value="Approved" />
...
<script>
    (function () {
        ...
        const initEventHandlers = (container) => {
            const serviceElement = container.querySelector("[name='service_id']");
            const dateElement = container.querySelector("[name='date']");
            const timeElement = container.querySelector("[name='time']");
            const startElement = container.querySelector("[name='start']");
        ...
        initEventHandlers(document.getElementById("create"));
        initEventHandlers(document.getElementById("createwalkin"));
    })()
</script>
@endsection